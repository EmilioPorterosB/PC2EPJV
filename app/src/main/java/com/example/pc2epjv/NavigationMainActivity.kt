...
import com.example.pc2epjv.databinding.ActivityNavigationMainBinding
...
class NavigationMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarNavigationMain.fab.setOnClickListener { view ->
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_navigation_main)
